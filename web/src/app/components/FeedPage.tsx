...
function PostCard({ 
  ...
  return (
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-md border border-gray-200/50 hover:shadow-lg hover:shadow-gray-200/50 transition-all duration-300 hover:scale-[1.01] hover:border-gray-300/50">
      ...
      <div className="px-4 py-2.5 md:px-6 md:py-3 border-t border-gray-100">
        {/* Reaction Summary */}
        <div className="flex items-center justify-between mb-2.5 md:mb-3">
          <div className="flex items-center space-x-3 md:space-x-4 text-sm md:text-sm text-gray-600">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            >
              ...
              <button
                ...
                className={`flex items-center space-x-1.5 md:space-x-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg transition-all duration-200 hover:scale-105 group relative z-10 ${
                  post.userReaction
            ...
            <button
              ...
              className="flex items-center space-x-1.5 md:space-x-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg hover:bg-gray-100 text-gray-600 transition-all duration-200 hover:scale-105 group"
            >
              ...
              <span className="text-sm md:text-sm font-medium">Comment</span>
            </button>

            <button className="flex items-center space-x-1.5 md:space-x-2 px-3 py-1.5 md:px-4 md:py-2 rounded-lg hover:bg-gray-100 text-gray-600 transition-all duration-200 hover:scale-105 group">
              <svg className="w-4 h-4 md:w-5 md:h-5 group-hover:text-gray-800 transition-colors duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {showComments && (
        <div className="border-t border-gray-100/80 animate-in slide-in-from-top-2 fade-in duration-300">
          ...
          {post.comments.map((comment, index) => (
            <div 
              key={comment.id} 
              className="px-4 py-3 md:px-6 md:py-4 border-b border-gray-50/80 last:border-b-0 hover:bg-gray-50/30 transition-all duration-200"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="flex items-start space-x-2.5 md:space-x-3 group">
                <div className="text-base md:text-lg transition-transform duration-200 group-hover:scale-110">{comment.author.avatar}</div>
                <div className="flex-1">
                  <div className="bg-gray-50/80 rounded-xl p-2.5 md:p-3 hover:bg-gray-100/80 transition-all duration-200">
                    <div className="flex items-center space-x-2 mb-1">
                      <span className="font-medium text-sm md:text-sm text-gray-900 group-hover:text-blue-600 transition-colors duration-200">{comment.author.name}</span>
                      <span className="text-xs text-gray-500">{comment.timestamp}</span>
                    </div>
                    <p className="text-sm md:text-sm text-gray-800 leading-relaxed">{comment.content}</p>
                  </div>
          ...
          {/* New Comment Form */}
          <form onSubmit={handleSubmitComment} className="px-4 py-3 md:px-6 md:py-4 bg-gray-50/30">
            <div className="flex items-start space-x-2.5 md:space-x-3">
              <div className="text-base md:text-lg transition-transform duration-200 hover:scale-110">👤</div>
              <div className="flex-1">
                <textarea
                  value={newComment}
                  onChange={(e) => setNewComment(e.target.value)}
                  placeholder="Write a comment..."
                  className="w-full p-2.5 md:p-3 border border-gray-300/50 rounded-xl resize-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none bg-white/80 backdrop-blur-sm transition-all duration-200 hover:border-gray-400/50 text-sm md:text-base"
                  rows={2}
                />
                <div className="flex justify-end mt-2.5 md:mt-3">
                  <button
                    ...
                    className="px-3.5 py-2 md:px-4 md:py-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 transform hover:scale-105 active:scale-95 flex items-center space-x-1.5 md:space-x-2 group shadow-md hover:shadow-lg disabled:shadow-none text-sm md:text-sm"
                  >
                    <svg className="w-3.5 h-3.5 md:w-4 md:h-4 group-hover:translate-x-0.5 transition-transform duration-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
